...
$show_address = ! empty( $mod_settings['display_options'] ) && in_array( 'address', $mod_settings['display_options'] );
$show_phone = ! empty( $mod_settings['display_options'] ) && in_array( 'phone', $mod_settings['display_options'] );
$show_website = ! empty( $mod_settings['display_options'] ) && in_array( 'website', $mod_settings['display_options'] );
...
<ul class="contact-info">
  ...
  <?php } if (!empty( $phone && $show_phone )) { ?>
    <li class="meta-phone"><a href="tel:<?php echo esc_attr( $phone_url ); ?>"><?php echo Helper::phone_icon(); ?> <?php echo esc_html( $phone ); ?></a></li>
  <?php } if (!empty( $website && $show_website )) { ?>
    <li class="meta-website"><a href="<?php echo esc_url( $website ); ?>"><?php echo Helper::globe_icon(); ?><?php echo esc_html( $website ); ?></a></li>
    ...
    <ul>
      ...
      if ( $has_doctor && Listing_Functions::is_enable_doctor_listing() ){
        if (!empty( $phone && $show_phone )) { ?>
          <li class="meta-phone doctor-list"><a href="tel:<?php echo esc_attr( $phone_url ); ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="<?php esc_attr_e( "Call for appointment", "listygo" ) ?>"><?php echo Helper::phone_icon(); ?> <?php echo esc_html( $appointment_label ); ?></a></li>
        <?php }
      } else {
        if ( Fns::is_enable_quick_view() ) { ?>
          <li class="meta-quick-view">
            <div class="rtcl-quick-view rtcl-btn" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="<?php esc_attr_e( "Quick view", "listygo" ) ?>" data-listing_id="<?php echo absint($listing->get_id()) ?>"><i class="rtcl-icon rtcl-icon-zoom-in"></i></div>
          </li>
        ...
        <li class="tooltip-item meta-favourite" data-bs-toggle="<?php esc_html_e("Favourite", "listygo") ?>" data-bs-placement="top" data-bs-trigger="hover" title="<?php esc_attr_e( "Favourite", "listygo" ) ?>">
        ...
        <li class="archive-gallery-pswp meta-gallery">
          <a href="#" class="rtcl-archive-gallery-trigger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="<?php esc_attr_e( "Gallery", "listygo" ) ?>"><?php echo Helper::thumb_icon(); ?></a>
          <?php 
