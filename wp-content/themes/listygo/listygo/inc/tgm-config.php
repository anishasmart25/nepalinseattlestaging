	...
	public function register_required_plugins(){
		$plugins = array(
			...
			array(
				...
				'slug'         => 'listygo-core',
				'source'       => 'listygo-core.1.0.18.zip',
				'required'     =>  true,
				'version'      => '1.0.18'
			),
			array(
			...
			array(
				...
				'source'       => 'classified-listing-pro.2.3.3.zip',
				'required'     =>  true,
				'version'      => '2.3.3'
			),
			array(
				...
				'source'       => 'classified-listing-store.1.5.7.zip',
				'required'     =>  true,
				'version'      => '1.5.7'
			),
			array(
				...
				'source'       => 'review-schema-pro.1.1.6.zip',
				'required'     =>  false,
				'version'      => '1.1.6'
			),
			array(
