...
class Rt_Car_Listings extends Custom_Widget_Base {

	public function __construct( $data = [], $args = null ){
		$this->rt_name = __( 'Car Listings', 'listygo-core' );
		$this->rt_base = 'rt-car-listings';
	...
	public function rt_fields(){
		$fields = array(
			array(
				'id'      => 'sec_rt_car_listings',
				'mode'    => 'section_start',
				'label'   => esc_html__( 'Car Listings List', 'listygo-core' ),
			),
			// Layout
			array(
				'id'      => 'style',
			...
			array(
				...
				'options' => array(
					'loccat' => esc_html__( 'By Locations & Categories', 'listygo-core' ),
