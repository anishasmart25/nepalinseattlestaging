...
class Listygo_Core {
	...
	public function php_version_message(){
		...
		$message = sprintf( __( 'The %1$sListygo Optimization%2$s requires %1$sphp 7.4+%2$s. Please consider updating php version and know more about it <a href="https://wordpress.org/about/requirements/" target="_blank">here</a>.', 'listygo-core' ), '<strong>', '</strong>' );
