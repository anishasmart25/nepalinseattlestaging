...
<form class="rtcl-EditAccountForm rtcl-MyAccount-content-inner" id="rtcl-user-account" method="post">
	...
	<h3 class="rtcl-myaccount-content-title"><?php _e( 'Account Details', 'classified-listing' ); ?></h3>
	...
	<div class="rtcl-form-group-wrap">
		...
		<div class="rtcl-form-group">
			...
			<div class="rtcl-field-col">
				...
				<p class="description small"><?php _e('e.g. https://example.com', 'classified-listing'); ?></p>
			</div>
		</div>
