...
<form id="rtcl-lost-password-form" class="form-horizontal" method="post">
	...
	<p><?php echo apply_filters( 'rtcl_lost_password_message',
	...
	<div class="rtcl-form-group">
		<label for="rtcl-user-login" class="rtcl-field-label">
			<?php _e( 'Username or E-mail', 'classified-listing' ); ?>
		</label>
	...
	<div class="rtcl-form-submit-wrap">
		<input type="submit" name="rtcl-lost-password" class="btn" value="<?php _e( 'Reset Password', 'classified-listing' ); ?>"/>
	</div>
