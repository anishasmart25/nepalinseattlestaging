                            ...
                            <div class="action-item time-slots">
                                ...
                                if (!empty($bhs[$day_key]['times'])) {
                                    foreach ($bhs[$day_key]['times'] as $time_id => $time) {
                                        ?>
                                        <div class="time-slot">
                                            <div class="time-slot-start" data-column="<?php esc_attr_e( 'Start', 'classified-listing' ); ?>">
                                                <input type="text"
                                            ...
                                            <div class="time-slot-end" data-column="<?php esc_attr_e( 'End', 'classified-listing' ); ?>">
                                                <input type="text"
