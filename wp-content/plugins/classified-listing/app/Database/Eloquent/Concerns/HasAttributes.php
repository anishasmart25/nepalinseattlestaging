...
//		$this->mergeAttributesFromClassCasts();
	...
	protected function isClassCastable( $key ) {
		...
		$class = $this->getModel();
		throw new RuntimeException( "Call to undefined cast [{$castType}] on column [{$key}] in model [{$class}]." );
	}
...
//		}
	...
	protected function castAttributeAsJson( $key, $value ) {
		...
		if ( $value === false ) {
			...
			throw new RuntimeException( "Unable to encode attribute [{$key}] for model [{$this}] to JSON: {$message}." );
		}
