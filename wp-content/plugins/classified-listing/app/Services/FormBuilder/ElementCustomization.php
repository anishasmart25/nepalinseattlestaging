...
class ElementCustomization {
	...
	public static function getSettingsPlacement(): array {
		$placement = [
			'listing_type'        => [
				'general' => [ 'label', 'label_placement', 'placeholder' ],
				'advance' => [ 'default_value', 'container_class', 'help_message' ]
			],
			'title'               => [
				'general' => [ 'label', 'label_placement', 'placeholder', 'validation' ],
				'advance' => [ 'default_value', 'container_class', 'help_message' ]
			],
			'description'         => [
				'general' => [ 'label', 'label_placement', 'editor_type', 'rows', 'validation' ],
				'advance' => [ 'container_class', 'help_message', 'admin_use_only' ]
			],
			'excerpt'             => [
				'general' => [ 'label', 'label_placement', 'validation' ],
				'advance' => [ 'container_class', 'help_message', 'admin_use_only' ]
			],
			'category'            => [
				'general' => [ 'label', 'label_placement', 'placeholder', 'validation' ],
			...
			'social_profiles'     => [
				'general' => [ 'label', 'label_placement', 'validation', 'admin_use_only' ]
			],
			'address'             => [
				'general' => [ 'label', 'label_placement', 'placeholder', 'validation', 'admin_use_only' ]
			],
			'zipcode'             => [
				'general' => [ 'label', 'label_placement', 'placeholder', 'validation', 'admin_use_only' ]
			],
			...
			'tag'                 => [
				'general' => [ 'label', 'label_placement', 'allow_new', 'validation' ],
				'advance' => [
					'container_class',
					'help_message',
					'admin_use_only',
			...
			'business_hours'      => [
				'general' => [ 'label', 'label_placement', 'time_format', 'validation' ],
				'advance' => [
					'container_class',
					'help_message',
					'admin_use_only'
			...
			'textarea'            => [
				'general' => [ 'label', 'label_placement', 'name', 'editor_type', 'rows', 'placeholder', 'validation' ],
				'advance' => [
					'default_value',
					'id',
					'container_class',
			...
			'url'                 => [
				'general' => [ 'label', 'label_placement', 'name', 'placeholder', 'validation' ],
				'advance' => [
					'default_value',
					'id',
					'container_class',
			...
			'color_picker'        => [
				'general' => [ 'label', 'label_placement', 'name', 'validation' ],
				'advance' => [
					'default_value',
					'id',
					'container_class',
		...
		$settingsFields     = [
			...
			'icon'                         => [
				...
				'options'  => [
					...
					[
						'value' => 'custom_class',
						'label' => __( 'Custom Class', 'classified-listing' ),
					]
				]
			],
			'selection_type'               => [
			...
			'pricing_options'              => [
				...
				'options'   => [
					[ 'label' => __( 'Pricing Type', 'classified-listing' ), 'value' => 'pricing_type' ],
					[ 'label' => __( 'Price Type', 'classified-listing' ), 'value' => 'price_type' ],
					[ 'label' => __( 'Price Unit', 'classified-listing' ), 'value' => 'price_unit' ]
				],
				'help_text' => __( 'This is the field title the user will see when filling out the form.', 'classified-listing' ),
			],
			'max_image_limit'              => [
			...
			'advanced_options'             => [
				...
				'config'    => [
					[ 'label' => __( 'Show Values', 'classified-listing' ), 'value' => 'values_visible' ],
				]
			],
			'allow_new'                    => [
			...
			'listable'                     => [
				'template'  => 'inputYesNoCheckBox',
				'label'     => __( 'Listable', 'classified-listing' ),
				'help_text' => __( 'If you enable this then filed will display at listings and single listings.', 'classified-listing' ),
			],
			'enable_select_2'              => [
				'template'  => 'inputYesNoCheckBox',
			...
			'logics'                       => [
				...
				'relation'     => [
					...
					'options'   => [
						[ 'value' => 'or', 'label' => __( 'OR', 'classified-listing' ) ],
						[ 'value' => 'and', 'label' => __( 'AND', 'classified-listing' ) ]
					]
				],
				'operators'    => [
					[ 'value' => '=', 'label' => __( 'Equal', 'classified-listing' ) ],
					[ 'value' => '!=', 'label' => __( 'Not equal', 'classified-listing' ) ],
					[ 'value' => '>', 'label' => __( 'greater than', 'classified-listing' ) ],
					[ 'value' => '<', 'label' => __( 'less than', 'classified-listing' ) ],
					[ 'value' => '>=', 'label' => __( 'greater than or equal', 'classified-listing' ) ],
					[ 'value' => '<=', 'label' => __( 'less than or equal', 'classified-listing' ) ],
					[ 'value' => 'contains', 'label' => __( 'Includes', 'classified-listing' ) ],
					[ 'value' => 'doNotContains', 'label' => __( 'Not includes', 'classified-listing' ) ],
					[ 'value' => 'startsWith', 'label' => __( 'Starts with', 'classified-listing' ) ],
					[ 'value' => 'endsWith', 'label' => __( 'Ends with', 'classified-listing' ) ],
					[ 'value' => 'empty', 'label' => __( 'Empty', 'classified-listing' ) ],
					[ 'value' => 'notEmpty', 'label' => __( 'Not Empty', 'classified-listing' ) ],
					[ 'value' => 'test_regex', 'label' => __( 'Regex match', 'classified-listing' ) ],
				],
				'selectFields' => [
					'listing_type',
					'location',
			...
			'layout_class'                 => [
				...
				'help_text' => __( 'Select the Layout for checkable items', 'classified-listing' ),
				'options'   => [
					[
						'value' => '',
						'label' => __( 'Default', 'classified-listing' ),
			...
			'upload_file_location'         => [
				'template'   => 'radio',
				'label'      => __( 'Save Uploads in', 'classified-listing' ),
				'help_text'  => __( 'Uploaded files can be stored in media library or your server or both.', 'classified-listing' ),
				'default'    => 'default',
				'options'    => Helper::fileUploadLocations(),
				'dependency' => [
					'depends_on' => 'file_location_type',
					'value'      => 'custom',
					'operator'   => '==',
				],
			],
			'file_location_type'           => [
				'template'  => 'radio',
				'label'     => __( 'File Location Type', 'classified-listing' ),
				'help_text' => __( 'Set default or custom location for files', 'classified-listing' ),
				'default'   => 'global',
				'options'   => [
					[
						'value' => 'global',
						'label' => __( 'As Per Global Settings', 'classified-listing' ),
					],
					[
						'value' => 'custom',
						'label' => __( 'Custom', 'classified-listing' ),
