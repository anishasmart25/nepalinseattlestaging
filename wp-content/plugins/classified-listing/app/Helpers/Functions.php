...
class Functions {
	...
	public static function get_my_account_page_endpoints() {
		$endpoints = [
			// My account actions.
			'listings'      => Functions::get_option_item( 'rtcl_advanced_settings', 'myaccount_listings_endpoint' ),
			'favourites'    => Functions::get_option_item( 'rtcl_advanced_settings', 'myaccount_favourites_endpoint' ),
			'payments'      => Functions::get_option_item( 'rtcl_advanced_settings', 'myaccount_payments_endpoint' ),
			'edit-account'  => Functions::get_option_item( 'rtcl_advanced_settings', 'myaccount_edit_account_endpoint' ),
			'lost-password' => Functions::get_option_item( 'rtcl_advanced_settings', 'myaccount_lost_password_endpoint' ),
			'logout'        => Functions::get_option_item( 'rtcl_advanced_settings', 'myaccount_logout_endpoint' )
		];
		...
		if ( self::isEnableFb() ) {
			...
			if ( !empty( $attachments ) ) {
				...
				if ( !get_post_meta( $post_id, '_rtcl_form_id', true ) ) {
					$attachments = Functions::sort_images( $attachments, $post_id );
				}
