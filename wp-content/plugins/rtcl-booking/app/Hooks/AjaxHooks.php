...
class AjaxHooks {
	...
	public static function rtcl_booking_confirmation() {
		...
		if ( apply_filters( 'rtcl_booking_form_remove_nonce', false ) || Functions::verify_nonce() ) {
			...
			if ( $wpdb->insert_id ) {
				Functions::add_notice( apply_filters( 'rtcl_booking_success_message', esc_html__( "Thank you for submitting booking request!", "rtcl-booking" ), $_REQUEST ) );
				$success = true;
			...
			Functions::add_notice( apply_filters( 'rtcl_booking_session_error_message', esc_html__( "Session Error !!", "rtcl-booking" ), $_REQUEST ), 'error' );
		}
	...
	public static function rtcl_booking_service_day_slots() {
		...
		?>
        <div id="service_slots" class="form-group">
			<?php if ( ! empty( $slots['open'] ) && ! isset( $slots['times'] ) ):
                ...
                <input type="text" id="service_slot" class="bhs-timepicker form-control" name="service_slots"
                       autocomplete="off" required/>
			<?php else: ?>
                <label for="service_slot"><?php esc_html_e( 'Time Slot', 'rtcl-booking' ); ?></label>
                <select id="service_slot" class="form-control" name="service_slots" required>
					<?php echo $options; ?>
                </select>
			<?php endif; ?>
