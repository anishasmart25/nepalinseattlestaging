			...
			<?php if ( 'my' == $booking_for ): ?>
				<?php if ( 'pending' === $booking->status ): ?>
                    <button id="cancel-booking"
                            class="btn btn-warning"><?php esc_html_e( 'Cancel', 'rtcl-booking' ); ?></button>
				<?php elseif ( 'canceled' == $booking->status ): ?>
                    <button id="delete-booking"
                            class="btn btn-danger"><?php esc_html_e( 'Delete', 'rtcl-booking' ); ?></button>
				<?php endif; ?>
			<?php else: ?>
				<?php if ( 'pending' == $booking->status ): ?>
                    <button id="approve-booking"
                            class="btn btn-primary"><?php esc_html_e( 'Approve', 'rtcl-booking' ); ?></button>
                    <button id="reject-booking"
                            class="btn btn-warning"><?php esc_html_e( 'Reject', 'rtcl-booking' ); ?></button>
