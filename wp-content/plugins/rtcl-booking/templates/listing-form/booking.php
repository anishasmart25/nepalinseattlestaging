...
$inputOffset = is_admin() ? 'offset-sm-2' : 'offset-sm-3';
?>
<div class="rtcl-post-booking rtcl-post-section<?php echo esc_attr( is_admin() ? " rtcl-is-admin" : '' ); ?>">
    ...
    <div id="rtcl-booking-holder" class="rtcl-booking-holder">
        ...
        <div class="rtcl-booking-wrap">
            <div class="form-group row rtcl-booking-type">
            ...
            <div class="rtcl-booking-fields">
				<?php if ( ! Functions::is_disable_booking_event_type() ) { ?>
                    <div class="form-group row rtcl-booking-event-fields">
                        <div class="<?php echo esc_attr( $inputColumn ); ?> <?php echo esc_attr( $inputOffset ); ?>">
                            ...
                            <label class="control-label" for="_rtcl_show_available_tickets">
                ...
                <div class="form-group row">
                    <div class="col-12 <?php echo esc_attr( $labelColumn ); ?>">
                        <label for="_rtcl_booking_fee"
                               class="control-label"><?php echo apply_filters( 'rtcl_booking_fee_label', Functions::get_booking_fee_label() ); ?></label>
                    </div>
                    <div class="col-12 <?php echo esc_attr( $inputColumn ); ?>">
                        <input type="number" class="form-control" id="_rtcl_booking_fee" name="_rtcl_booking_fee"
                    ...
                    <div class="form-group row rtcl-booking-event-fields">
                        <div class="col-12 <?php echo esc_attr( $labelColumn ); ?>">
                            <label for="_rtcl_available_tickets"
                                   class="control-label"><?php echo apply_filters( 'rtcl_booking_get_available_ticket_label', Functions::get_available_ticket_label() ); ?></label>
                        </div>
                        <div class="col-12 <?php echo esc_attr( $inputColumn ); ?>">
                            <input type="number" class="form-control" id="_rtcl_available_tickets"
                    ...
                    <div class="form-group row rtcl-booking-event-fields">
                        <div class="col-12 <?php echo esc_attr( $labelColumn ); ?>">
                            <label for="_rtcl_booking_allowed_ticket"
                                   class="control-label"><?php echo apply_filters( 'rtcl_booking_ticket_allowed_per_booking_label', Functions::get_ticket_allowed_per_booking_label() ); ?></label>
                        </div>
                        <div class="col-12 <?php echo esc_attr( $inputColumn ); ?>">
                            <input type="number" class="form-control" id="_rtcl_booking_allowed_ticket"
				...
				<?php if ( ! Functions::is_disable_booking_service_type() ) { ?>
                    <div class="form-group row rtcl-booking-service-fields">
                        <div class="col-12 <?php echo esc_attr( $labelColumn ); ?>">
                            <label for="_rtcl_booking_max_guest"
                                   class="control-label"><?php echo apply_filters( 'rtcl_booking_max_no_of_guest_label', Functions::get_maximum_number_of_guest_label() ); ?></label>
                        </div>
                        <div class="col-12 <?php echo esc_attr( $inputColumn ); ?>">
                            <input type="number" class="form-control" id="_rtcl_booking_max_guest"
                                    ...
                                    <div class="rtcl-booking-service-slot">
                                        ...
                                        <div class="rtcl-day-actions">
                                            ...
                                            <input type="checkbox" name="_rtcl_shs[<?php echo $day_key ?>][open]"
                                                   ...
                                                   id="service-hours-open-<?php echo esc_html( $day_key ); ?>"<?php echo ! empty( $shs[ $day_key ]['open'] ) ? ' checked' : '' ?>>
				...
				<?php if ( ! Functions::is_disable_booking_pre_order_type() ) {
					...
					?>
                    <div class="form-group row rtcl-booking-pre-order-fields">
                        <div class="col-12 <?php echo esc_attr( $labelColumn ); ?>">
                            <label for="_rtcl_booking_pre_order_date"
                                   class="control-label"><?php echo apply_filters( 'rtcl_booking_pre_order_date_label', Functions::get_pre_order_date_label() ); ?></label>
                        </div>
                        <div class="col-12 <?php echo esc_attr( $inputColumn ); ?>">
                            <input type="text" class="rtcl-date form-control" id="_rtcl_booking_pre_order_date"
                    ...
                    <div class="form-group row rtcl-booking-pre-order-fields">
                        <div class="col-12 <?php echo esc_attr( $labelColumn ); ?>">
                            <label for="_rtcl_booking_pre_order_available_date"
                                   class="control-label"><?php echo apply_filters( 'rtcl_booking_pre_order_available_date_label', Functions::get_pre_order_availalbe_date_label() ); ?></label>
                        </div>
                        <div class="col-12 <?php echo esc_attr( $inputColumn ); ?>">
                            <input type="text" class="rtcl-date form-control"
                    ...
                    <div class="form-group row rtcl-booking-pre-order-fields">
                        <div class="col-12 <?php echo esc_attr( $labelColumn ); ?>">
                            <label for="_rtcl_booking_pre_order_available_volumn"
                                   class="control-label"><?php echo apply_filters( 'rtcl_booking_pre_order_available_volumn_label', Functions::get_pre_order_availalbe_volumn_label() ); ?></label>
                        </div>
                        <div class="col-12 <?php echo esc_attr( $inputColumn ); ?>">
                            <input type="number" class="form-control" id="_rtcl_booking_pre_order_available_volumn"
                    ...
                    <div class="form-group row rtcl-booking-pre-order-fields">
                        <div class="col-12 <?php echo esc_attr( $labelColumn ); ?>">
                            <label for="_rtcl_booking_pre_order_maximum"
                                   class="control-label"><?php echo apply_filters( 'rtcl_booking_pre_order_maximum_label', Functions::get_pre_order_per_order_label() ); ?></label>
                        </div>
                        <div class="col-12 <?php echo esc_attr( $inputColumn ); ?>">
                            <input type="number" class="form-control" id="_rtcl_booking_pre_order_maximum"
				...
				<?php if ( ! Functions::is_disable_booking_rent_type() ) { ?>
                    <div class="form-group row rtcl-booking-rent-fields">
                        <div class="col-12 <?php echo esc_attr( $labelColumn ); ?>">
                            <label for="_rtcl_booking_rent_max_guest"
                                   class="control-label"><?php echo apply_filters( 'rtcl_booking_max_no_of_guest_label', Functions::get_maximum_number_of_guest_label() ); ?></label>
                        </div>
                        <div class="col-12 <?php echo esc_attr( $inputColumn ); ?>">
                            <input type="number" class="form-control" id="_rtcl_booking_rent_max_guest"
                    ...
                    <div class="form-group row rtcl-booking-rent-fields">
                        <div class="col-12 <?php echo esc_attr( $labelColumn ); ?>">
                            <label for="_rtcl_booking_rent_date"
                                   class="control-label"><?php echo apply_filters( 'rtcl_booking_rent_date_label', __( 'Unavailable Date', 'rtcl-booking' ) ); ?></label>
				...
				<?php } ?>
                <div class="form-group row">
                    <div class="col-6 <?php echo esc_attr( $labelColumn ); ?>">
                        <label class="control-label"><?php echo apply_filters( 'rtcl_booking_instant_booking_label', Functions::get_instant_booking_label() ); ?></label>
                    </div>
                    <div class="col-6 <?php echo esc_attr( $inputColumn ); ?>">
                        <input type="checkbox" name="_rtcl_instant_booking" value="1"
                               id="_rtcl_instant_booking" <?php checked( $instantBooking, '1', true ); ?>/>
                        <label class="control-label"
                               for="_rtcl_instant_booking"><?php esc_html_e( 'Enable', 'rtcl-booking' ); ?></label>
                    </div>
                </div>
            </div>
        </div>
