    ...
    <div class="rtcl-booking-confirmation-wrapper">
        ...
        <form method="post" class="rtcl-booking-confirmation-form">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" value="<?php echo esc_attr( $name ); ?>"
                       required/>
            </div>
            <div class="form-group">
			...
			<?php endif; ?>
            <button type="submit" class="btn btn-primary"><?php esc_html_e( 'Confirm', 'rtcl-booking' ); ?></button>
        </form>
    </div>
